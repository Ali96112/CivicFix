      ...
      <section className="hero">
        ...
        <div className="hero__left">
          ...
          <div className="hero__cta">
            ...
            <button className="btn-hero-secondary">📊 View Dashboard</button>
          </div>
        ...
        <div className="hero__right">
          ...
          <div className="stat-card stat-card--wide">
            ...
            <div className="flow">
              {FLOW.map(
                (item,i, // loop through every item in the FLOW array
                ) =>
          ...
          {STEPS.map((step) => (
            <div key={step.num} className="step-card">
              <div className="step-card__top">
                <div className="step-card__icon" style={{ backgroundColor: step.bg }}>
                  {step.icon}
                </div>
              ...
              <div className="step-card__bar" style={{ backgroundColor: step.color }} />
            </div>
          ))}
        </div>
      </section>
...
{/* ── CTA Section ── */}
      <section className="cta"> {/* green gradient section */}
        ...
        <p className="cta__desc">
          Lebanon's infrastructure won't fix itself. Every report you submit is a step toward the country your children deserve.
        </p>

        {/* buttons row */}
        <div className="cta__buttons"> {/* flex row — buttons side by side */}
        ...
        </div> {/* end cta__buttons */}

      </section> {/* end cta */}

      {/* ── Flag Strip ── */}
      <div className="flag-strip"> {/* white bar — red line | cedar | green line */}

        <div className="flag-strip__red" />   {/* red line on the left — empty div styled by CSS */}

        {/* cedar SVG — sits in the center between the two lines */}
        <svg width="36" height="36" viewBox="0 0 80 80" fill="none" style={{ zIndex: 2 }}>
          <rect x="36" y="60" width="8" height="15" rx="3" fill="#7B4A1E" />   {/* trunk */}
          <ellipse cx="40" cy="56" rx="34" ry="6" fill="#00843D" />            {/* bottom layer */}
          <ellipse cx="40" cy="44" rx="26" ry="6" fill="#009A47" />            {/* middle layer */}
          <ellipse cx="40" cy="33" rx="18" ry="5.5" fill="#00B050" />         {/* upper layer */}
          <ellipse cx="40" cy="23" rx="12" ry="5" fill="#00C45A" />           {/* top layer */}
          <ellipse cx="40" cy="14" rx="7" ry="4.5" fill="#00D464" />          {/* near top */}
          <ellipse cx="40" cy="7" rx="4" ry="3.5" fill="#00E070" />           {/* tip */}
        </svg>

        <div className="flag-strip__green" />  {/* green line on the right — empty div styled by CSS */}
      ...
      <footer className="footer"> {/* white footer */}
        ...
        <div className="footer__top">
          <div className="footer__brand">Civic<span>Fix</span> 🇱🇧</div> {/* "Fix" colored red via CSS */}
        ...
        <div className="footer__bottom">
          ...
          <span className="footer__tagline">Digital infrastructure for Lebanon's municipalities</span>
